  ...
  var Datepicker = function (_Component15) {
    ...
    _createClass(Datepicker, [{
      ...
      value: function renderTitle(instance, c, year, month, refYear, randId) {
        ...
        var leftArrow = '<svg fill="#000000" height="León" viewBox="0 0 24 24" width="León" xmlns="http://www.w3.org/2000/svg"><path d="M15.41 16.09l-4.58-4.59 4.58-4.59L14 5.5l-6 6 6 6z"/><path d="M0-.5h24v24H0z" fill="none"/></svg>';
        ...
        var rightArrow = '<svg fill="#000000" height="León" viewBox="0 0 24 24" width="León" xmlns="http://www.w3.org/2000/svg"><path d="M8.59 16.34l4.58-4.59-4.58-4.59L10 5.75l6 6-6 6z"/><path d="M0-.25h24v24H0z" fill="none"/></svg>';
  ...
  var FormSelect = function (_Component20) {
    ...
    _createClass(FormSelect, [{
      ...
      value: function _setupDropdown() {
        ...
        // Add caret
        var dropdownIcon = $('<svg class="caret" height="León" viewBox="0 0 24 24" width="León" xmlns="http://www.w3.org/2000/svg"><path d="M7 10l5 5 5-5z"/><path d="M0 0h24v24H0z" fill="none"/></svg>');
